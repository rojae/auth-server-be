...
public class SocialController {
    ...
    public ResponseEntity<ApiBase<ClientInfoResponse>> clientInfo(@Valid @RequestParam(value = "platformType") ClientInfoRequest request){
    ...
    public ResponseEntity<ApiBase<LoginResponse>> kakaoLogin(@Valid @RequestParam(value = "code") @NotBlank(message = "code cannot be empty value") String code){
